...
urlpatterns = [
    ...
    path("lawyer-credentials/", views.lawyer_credentials, name="lawyer_credentials"),
    ...
    path("admin/payments/<int:payment_id>/timeline/", views.admin_payment_timeline, name="admin_payment_timeline"),
    path("admin/payments/<int:payment_id>/status/", views.admin_update_payment, name="admin_update_payment"),
    path("admin/operations/audit/", views.admin_operational_events, name="admin_operational_events"),
    path("admin/operations/health/", views.admin_health, name="admin_health"),
    path("admin/operations/provider-events/", views.admin_provider_events, name="admin_provider_events"),
    path("admin/operations/provider-events/<int:event_id>/", views.admin_provider_event_detail, name="admin_provider_event_detail"),
    path("admin/operations/tasks/", views.admin_task_events, name="admin_task_events"),
    ...
    path("payment/<int:booking_id>/<str:status>/", views.payment_page_legacy_status_redirect, name="payment_page_legacy_status_redirect"),
